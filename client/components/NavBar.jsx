...
export default function NavBar() {
    return (
        <div className='grid grid-cols-4'>
            <p className='col-span-3 mt-5 text-base px-10 place-content-start text-aqua'>
                Mark Gowen
            </p>
            <ul className="flex items-center place-content-end mt-5 px-20  text-sm text-aqua">
                ...
                <button className="ml-5 px-5 py-1 border border-aqua rounded-none hover:text-silver hover:border-silver">Admin</button>
            </ul>
        </div>
    )
}