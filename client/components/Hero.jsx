...
export default function Hero() {
    return (
        <div className="mt-36 m-auto pl-8 max-w-[1000px]">
            ...
            <p className="pt-4 text-xl w-1/2 text-silver">I am a software engineer that has a passion for building user-friendly and beautiful <em className="text-salmon not-italic">front-end applications.</em></p>
