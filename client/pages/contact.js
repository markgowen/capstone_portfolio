    ...
    <>
        ...
        <div className="relative mx-auto max-w-xl">
          ...
          >
            <defs>
              <pattern
                ...
                patternUnits="userSpaceOnUse"
              >
                <rect x={0} y={0} width={4} height={4} className="text-silver" fill="currentColor" />
              </pattern>
            </defs>
            <rect width={404} height={404} fill="url(#85737c0e-0916-41d7-917f-596dc7edfa27)" />
          </svg>
          <div className="text-center">
            <h2 className="text-3xl font-bold tracking-tight text-salmon sm:text-4xl">Say Hello</h2>
          ...
          <div className="mt-12">
            <form ref={form} onSubmit={sendEmail} className="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
              ...
              <div>
                <label htmlFor="last-name" className="block text-sm font-medium text-aqua">
                  Last name
                </label>
                <div className="mt-1">
                  <input
              ...
              <div className="sm:col-span-2">
                <label htmlFor="company" className="block text-sm font-medium text-aqua">
                  Company
                </label>
                <div className="mt-1">
                  <input
              ...
              <div className="sm:col-span-2">
                <label htmlFor="phone-number" className="block text-sm font-medium text-aqua">
                  Phone Number
                </label>
              ...
              <div className="sm:col-span-2 mb-4">
                <label htmlFor="message" className="block text-sm font-medium text-aqua">
                  Message
                </label>
                <div className="mt-1">
                  <textarea
      ...
      <div className="flex w-full flex-col items-center space-y-4 sm:items-end">
        ...
        <Transition
          ...
          leaveTo="opacity-0"
        >
          <div className="pointer-events-auto -mt-12 mr-4 mb-6 z-10
